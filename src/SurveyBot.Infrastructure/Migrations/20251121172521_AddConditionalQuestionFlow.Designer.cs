...
namespace SurveyBot.Infrastructure.Migrations
{
    ...
    [Migration("20251121172521_AddConditionalQuestionFlow")]
    partial class AddConditionalQuestionFlow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyBot.Core.Entities.Question", b =>
                {
                    ...
                    b.Property<int?>("DefaultNextQuestionId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("DefaultNextQuestionId")
            ...
            modelBuilder.Entity("SurveyBot.Core.Entities.Question", b =>
                {
                    b.HasOne("SurveyBot.Core.Entities.Question", "DefaultNextQuestion")
                        .WithMany()
                        .HasForeignKey("DefaultNextQuestionId")
                    ...
                    b.Navigation("DefaultNextQuestion");
            ...
            modelBuilder.Entity("SurveyBot.Core.Entities.QuestionOption", b =>
                {
                    b.HasOne("SurveyBot.Core.Entities.Question", "NextQuestion")
                        .WithMany()
